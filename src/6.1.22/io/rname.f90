...
DATA INDAT/  &
     ...
     ,'IDUST','ICCNLEV','IFORCECCN','IPRINTAERO','BLH','FCCNTS','FCCNSTART'             &
...
IF(GROUP.EQ.'$MODEL_OPTIONS') THEN
 ...
 IF(VR.EQ.'LEVEL')        CALL varseti (VR,LEVEL,NV,1,II,0,3)
 ...
 IF(VR.EQ.'IPRINTAERO')   CALL varseti (VR, IPRINTAERO,NV,1,II,0,1)
